...
export default function AboutUs() {
  return (
    <div className="min-h-screen font-Dana antialiased">
      <div
        className="bg-[url(./../public/images/AboutUs.webp)] w-full 
      bg-cover bg-center bg-no-repeat xs:aspect[2/1]  h-50 xs:h-70
        md:h-170 lg:h-screen flex mt-15 md:mt-0 z-30 "
      >
        <div
          className="text-white font-DanaDemiBold w-full h-full flex flex-col
         justify-center items-center gap-5 md:gap-10"
        >
          <h2 className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl ">درباره ما</h2>
          <span className="w-[30%] md:w-[35%] h-0.5 inline-block bg-orange-300"></span>
          <p className="text-base sm:text-lg md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl w-1/2 text-center ">
            گلدکافی میزبان شماست دوست دارید «ما» را بشناسید؟
          </p>
        </div>
      </div>
      <main
      ...
      >
        ...
        <section className="max-w-5xl mx-auto px-6 md:py-14">
          <div className="rounded-3xl py-10 md:p-10  text-center ">
            ...
            <div className="space-y-4 mb-10 ">
              <h2 className="text-3xl font-bold">وبسایت گلدن کافی</h2>
        ...
        <section className="max-w-5xl mx-auto px-6 py-14">
          <div className="rounded-3xl md:p-10">
            <h2 className="text-3xl font-bold  text-center">داستان ما</h2>
